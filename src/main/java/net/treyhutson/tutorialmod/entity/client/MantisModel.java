...
public class MantisModel<T extends MantisEntity> extends EntityModel<MantisEntityRenderState> {
    ...
    public void setAngles(MantisEntityRenderState mantisEntityRenderState) {
        ...
        this.setHeadAngles(mantisEntityRenderState, mantisEntityRenderState.yawDegrees, mantisEntityRenderState.pitch);
        this.animateWalking(MantisAnimations.ANIM_MANTIS_WALK, mantisEntityRenderState.limbFrequency, mantisEntityRenderState.limbAmplitudeMultiplier, 2.0F, 2.5F);
    ...
    private void setHeadAngles(MantisEntityRenderState mantisEntityRenderState, float headYaw, float headPitch) {
